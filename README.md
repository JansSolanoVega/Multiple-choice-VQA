...
1. To evaluate and train BLIP, execure notebook named [blip_train.ipynb](BLIP/https://github.com/JansSolanoVega/Multiple-choice-VQA/blob/main/BLIP/blip_train.ipynb)
